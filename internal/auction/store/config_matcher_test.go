...
func TestConfigMatcher_Match(t *testing.T) {
	...
	for _, tC := range testCases {
		got, err := matcher.Match(context.Background(), tC.args.appID, tC.args.adType)
		if err != nil {
