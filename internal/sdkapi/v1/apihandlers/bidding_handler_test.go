...
func testHelperBiddingHandler(t *testing.T) apihandlers.BiddingHandler {
	app := sdkapi.App{ID: 1}
	...
	handler := apihandlers.BiddingHandler{
		BaseHandler: &apihandlers.BaseHandler[schema.BiddingRequest, *schema.BiddingRequest]{
