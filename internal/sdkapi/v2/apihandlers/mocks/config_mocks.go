...
// Ensure, that AdapterInitConfigsFetcherMock does implement apihandlers.AdapterInitConfigsFetcher.
// If this is not the case, regenerate this file with moq.
var _ apihandlers.AdapterInitConfigsFetcher = &AdapterInitConfigsFetcherMock{}

// AdapterInitConfigsFetcherMock is a mock implementation of apihandlers.AdapterInitConfigsFetcher.
//
//	func TestSomethingThatUsesAdapterInitConfigsFetcher(t *testing.T) {
//
//		// make and configure a mocked apihandlers.AdapterInitConfigsFetcher
...
//		}
//
//		// use mockedAdapterInitConfigsFetcher in code that requires apihandlers.AdapterInitConfigsFetcher
...
type AdapterInitConfigsFetcherMock struct {
	...
	calls struct {
		...
		FetchAdapterInitConfigs []struct {
			...
			// SetAmazonSlots is the setAmazonSlots argument value.
			SetAmazonSlots bool
...
func (mock *AdapterInitConfigsFetcherMock) FetchAdapterInitConfigs(ctx context.Context, appID int64, adapterKeys []adapter.Key, setAmazonSlots bool, setOrder bool) ([]sdkapi.AdapterInitConfig, error) {
	...
	return mock.FetchAdapterInitConfigsFunc(ctx, appID, adapterKeys, setAmazonSlots, setOrder)
}
