...
impl std::convert::TryFrom<header::IntoHeaderValue<AdFormat>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AdFormat>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AdFormat - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
             ...
             std::result::Result::Ok(value) => {
                    match <AdFormat as std::str::FromStr>::from_str(value) {
                        ...
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AdFormat - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AdFormat>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AdFormat>>) -> std::result::Result<Self, Self::Error> {
...
impl AdObject {
    ...
    pub fn new(auction_pricefloor: f64, demands: std::collections::HashMap<String, serde_json::Value>, ) -> AdObject {
        AdObject {
...
impl std::string::ToString for AdObject {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            self.auction_configuration_id.as_ref().map(|auction_configuration_id| {
                [
                    "auction_configuration_id".to_string(),
                    auction_configuration_id.to_string(),
                ].join(",")
            }),
            self.auction_configuration_uid.as_ref().map(|auction_configuration_uid| {
                [
                    "auction_configuration_uid".to_string(),
                    auction_configuration_uid.to_string(),
                ].join(",")
            }),
            self.auction_id.as_ref().map(|auction_id| {
                [
                    "auction_id".to_string(),
                    auction_id.to_string(),
                ].join(",")
            }),
            self.auction_key.as_ref().map(|auction_key| {
                [
                    "auction_key".to_string(),
                    auction_key.to_string(),
                ].join(",")
            }),
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AdObject".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "auction_configuration_id" => intermediate_rep.auction_configuration_id.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_configuration_uid" => intermediate_rep.auction_configuration_uid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_id" => intermediate_rep.auction_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_key" => intermediate_rep.auction_key.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_pricefloor" => intermediate_rep.auction_pricefloor.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "banner" => intermediate_rep.banner.push(<models::BannerAdObject as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "demands" => return std::result::Result::Err("Parsing a container in this style is not supported in AdObject".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "interstitial" => intermediate_rep.interstitial.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "orientation" => intermediate_rep.orientation.push(<models::AdObjectOrientation as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "rewarded" => intermediate_rep.rewarded.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AdObject".to_string())
                }
            }
        ...
        std::result::Result::Ok(AdObject {
            ...
            auction_configuration_uid: intermediate_rep.auction_configuration_uid.into_iter().next(),
            auction_id: intermediate_rep.auction_id.into_iter().next(),
            auction_key: intermediate_rep.auction_key.into_iter().next(),
            auction_pricefloor: intermediate_rep.auction_pricefloor.into_iter().next().ok_or_else(|| "auction_pricefloor missing in AdObject".to_string())?,
            banner: intermediate_rep.banner.into_iter().next(),
            demands: intermediate_rep.demands.into_iter().next().ok_or_else(|| "demands missing in AdObject".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<AdObject>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AdObject>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AdObject - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AdObject as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AdObject - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AdObject>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AdObject>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::convert::TryFrom<header::IntoHeaderValue<AdObjectOrientation>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AdObjectOrientation>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AdObjectOrientation - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AdObjectOrientation>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AdObjectOrientation>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AdObjectOrientation>> {
    type Error = String;
...
impl std::string::ToString for AdUnit {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.pricefloor.as_ref().map(|pricefloor| {
                [
                    "pricefloor".to_string(),
                    pricefloor.to_string(),
                ].join(",")
            }),
            Some("uid".to_string()),
...
impl std::str::FromStr for AdUnit {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AdUnit".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "bid_type" => intermediate_rep.bid_type.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "demand_id" => intermediate_rep.demand_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "ext" => return std::result::Result::Err("Parsing a container in this style is not supported in AdUnit".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "label" => intermediate_rep.label.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "pricefloor" => intermediate_rep.pricefloor.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "uid" => intermediate_rep.uid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AdUnit".to_string())
                }
            }
        ...
        std::result::Result::Ok(AdUnit {
            bid_type: intermediate_rep.bid_type.into_iter().next().ok_or_else(|| "bid_type missing in AdUnit".to_string())?,
            demand_id: intermediate_rep.demand_id.into_iter().next().ok_or_else(|| "demand_id missing in AdUnit".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            label: intermediate_rep.label.into_iter().next().ok_or_else(|| "label missing in AdUnit".to_string())?,
            pricefloor: intermediate_rep.pricefloor.into_iter().next(),
            uid: intermediate_rep.uid.into_iter().next().ok_or_else(|| "uid missing in AdUnit".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AdUnit>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AdUnit>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AdUnit - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AdUnit as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AdUnit - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AdUnit>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AdUnit>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::str::FromStr for Adapter {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing Adapter".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "sdk_version" => intermediate_rep.sdk_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "version" => intermediate_rep.version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing Adapter".to_string())
                }
            }
        ...
        std::result::Result::Ok(Adapter {
            sdk_version: intermediate_rep.sdk_version.into_iter().next().ok_or_else(|| "sdk_version missing in Adapter".to_string())?,
            version: intermediate_rep.version.into_iter().next().ok_or_else(|| "version missing in Adapter".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<Adapter>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Adapter>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Adapter - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Adapter as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Adapter - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Adapter>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Adapter>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::string::ToString for App {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.sdk_version.as_ref().map(|sdk_version| {
                [
            ...
            self.skadn.as_ref().map(|skadn| {
                [
                    "skadn".to_string(),
                    skadn.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(","),
                ].join(",")
            }),
            Some("version".to_string()),
            Some(self.version.to_string()),
...
impl std::str::FromStr for App {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing App".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "bundle" => intermediate_rep.bundle.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "framework" => intermediate_rep.framework.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "framework_version" => intermediate_rep.framework_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "key" => intermediate_rep.key.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "plugin_version" => intermediate_rep.plugin_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "sdk_version" => intermediate_rep.sdk_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "skadn" => return std::result::Result::Err("Parsing a container in this style is not supported in App".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "version" => intermediate_rep.version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing App".to_string())
                }
            }
        ...
        std::result::Result::Ok(App {
            bundle: intermediate_rep.bundle.into_iter().next().ok_or_else(|| "bundle missing in App".to_string())?,
            framework: intermediate_rep.framework.into_iter().next().ok_or_else(|| "framework missing in App".to_string())?,
            framework_version: intermediate_rep.framework_version.into_iter().next(),
            key: intermediate_rep.key.into_iter().next().ok_or_else(|| "key missing in App".to_string())?,
            ...
            version: intermediate_rep.version.into_iter().next().ok_or_else(|| "version missing in App".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<App>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<App>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for App - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<App> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <App as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into App - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<App>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<App>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl AuctionAdUnitResult {
    #[allow(clippy::new_without_default)]
    pub fn new(demand_id: String, status: models::AuctionAdUnitResultStatus, ) -> AuctionAdUnitResult {
        AuctionAdUnitResult {
            ad_unit_label: None,
            ad_unit_uid: None,
            bid_type: None,
    ...
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            self.ad_unit_label.as_ref().map(|ad_unit_label| {
                [
                    "ad_unit_label".to_string(),
                    ad_unit_label.to_string(),
                ].join(",")
            }),
            self.ad_unit_uid.as_ref().map(|ad_unit_uid| {
                [
                    "ad_unit_uid".to_string(),
                    ad_unit_uid.to_string(),
                ].join(",")
            }),
            ...
            self.fill_finish_ts.as_ref().map(|fill_finish_ts| {
                [
                    "fill_finish_ts".to_string(),
                    fill_finish_ts.to_string(),
                ].join(",")
            }),
            self.fill_start_ts.as_ref().map(|fill_start_ts| {
                [
                    "fill_start_ts".to_string(),
                    fill_start_ts.to_string(),
                ].join(",")
            }),
            ...
            self.token_finish_ts.as_ref().map(|token_finish_ts| {
                [
                    "token_finish_ts".to_string(),
                    token_finish_ts.to_string(),
                ].join(",")
            }),
            self.token_start_ts.as_ref().map(|token_start_ts| {
                [
                    "token_start_ts".to_string(),
                    token_start_ts.to_string(),
                ].join(",")
            }),
        ];
...
impl std::str::FromStr for AuctionAdUnitResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AuctionAdUnitResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "ad_unit_label" => intermediate_rep.ad_unit_label.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ad_unit_uid" => intermediate_rep.ad_unit_uid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "bid_type" => intermediate_rep.bid_type.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "demand_id" => intermediate_rep.demand_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "error_message" => intermediate_rep.error_message.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "fill_finish_ts" => intermediate_rep.fill_finish_ts.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "fill_start_ts" => intermediate_rep.fill_start_ts.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "price" => intermediate_rep.price.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<models::AuctionAdUnitResultStatus as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "token_finish_ts" => intermediate_rep.token_finish_ts.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "token_start_ts" => intermediate_rep.token_start_ts.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AuctionAdUnitResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(AuctionAdUnitResult {
            ...
            demand_id: intermediate_rep.demand_id.into_iter().next().ok_or_else(|| "demand_id missing in AuctionAdUnitResult".to_string())?,
            ...
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in AuctionAdUnitResult".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionAdUnitResult>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionAdUnitResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionAdUnitResult - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionAdUnitResult>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionAdUnitResult>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionAdUnitResult>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionAdUnitResultStatus>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionAdUnitResultStatus>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionAdUnitResultStatus - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionAdUnitResultStatus>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionAdUnitResultStatus>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionAdUnitResultStatus>> {
    type Error = String;
...
impl AuctionRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ad_object: models::AdObject, adapters: std::collections::HashMap<String, models::Adapter>, ) -> AuctionRequest {
        AuctionRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for AuctionRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AuctionRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "app" => intermediate_rep.app.push(<models::App as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "device" => intermediate_rep.device.push(<models::Device as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ext" => intermediate_rep.ext.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "geo" => intermediate_rep.geo.push(<models::Geo as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "regs" => intermediate_rep.regs.push(<models::Regulations as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "segment" => intermediate_rep.segment.push(<models::Segment as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "session" => intermediate_rep.session.push(<models::Session as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    #[allow(clippy::redundant_clone)]
                    "ad_object" => intermediate_rep.ad_object.push(<models::AdObject as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "adapters" => return std::result::Result::Err("Parsing a container in this style is not supported in AuctionRequest".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "test" => intermediate_rep.test.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "tmax" => intermediate_rep.tmax.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AuctionRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(AuctionRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in AuctionRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in AuctionRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            ...
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in AuctionRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in AuctionRequest".to_string())?,
            ad_object: intermediate_rep.ad_object.into_iter().next().ok_or_else(|| "ad_object missing in AuctionRequest".to_string())?,
            adapters: intermediate_rep.adapters.into_iter().next().ok_or_else(|| "adapters missing in AuctionRequest".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AuctionRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AuctionRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionRequest>> {
    type Error = String;
...
impl AuctionResponse {
    #[allow(clippy::new_without_default)]
    pub fn new(ad_units: Vec<models::AdUnit>, auction_configuration_id: i64, auction_configuration_uid: String, auction_id: String, auction_pricefloor: f64, auction_timeout: i32, external_win_notifications: bool, segment: models::Segment, token: String, ) -> AuctionResponse {
        AuctionResponse {
            ad_units,
...
impl std::str::FromStr for AuctionResponse {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AuctionResponse".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "ad_units" => return std::result::Result::Err("Parsing a container in this style is not supported in AuctionResponse".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "auction_configuration_id" => intermediate_rep.auction_configuration_id.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_configuration_uid" => intermediate_rep.auction_configuration_uid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    ...
                    "auction_pricefloor" => intermediate_rep.auction_pricefloor.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_timeout" => intermediate_rep.auction_timeout.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "external_win_notifications" => intermediate_rep.external_win_notifications.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "no_bids" => return std::result::Result::Err("Parsing a container in this style is not supported in AuctionResponse".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "segment" => intermediate_rep.segment.push(<models::Segment as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "token" => intermediate_rep.token.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AuctionResponse".to_string())
                }
            }
        ...
        std::result::Result::Ok(AuctionResponse {
            ad_units: intermediate_rep.ad_units.into_iter().next().ok_or_else(|| "ad_units missing in AuctionResponse".to_string())?,
            auction_configuration_id: intermediate_rep.auction_configuration_id.into_iter().next().ok_or_else(|| "auction_configuration_id missing in AuctionResponse".to_string())?,
            auction_configuration_uid: intermediate_rep.auction_configuration_uid.into_iter().next().ok_or_else(|| "auction_configuration_uid missing in AuctionResponse".to_string())?,
            auction_id: intermediate_rep.auction_id.into_iter().next().ok_or_else(|| "auction_id missing in AuctionResponse".to_string())?,
            auction_pricefloor: intermediate_rep.auction_pricefloor.into_iter().next().ok_or_else(|| "auction_pricefloor missing in AuctionResponse".to_string())?,
            auction_timeout: intermediate_rep.auction_timeout.into_iter().next().ok_or_else(|| "auction_timeout missing in AuctionResponse".to_string())?,
            external_win_notifications: intermediate_rep.external_win_notifications.into_iter().next().ok_or_else(|| "external_win_notifications missing in AuctionResponse".to_string())?,
            no_bids: intermediate_rep.no_bids.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next().ok_or_else(|| "segment missing in AuctionResponse".to_string())?,
            token: intermediate_rep.token.into_iter().next().ok_or_else(|| "token missing in AuctionResponse".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionResponse>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionResponse>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionResponse - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AuctionResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AuctionResponse - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionResponse>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionResponse>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionResponse>> {
    type Error = String;
...
impl std::string::ToString for AuctionResult {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            // Skipping non-primitive type rewarded in query parameter serialization
            // Skipping non-primitive type status in query parameter serialization
            self.winner_ad_unit_label.as_ref().map(|winner_ad_unit_label| {
                [
...
impl std::str::FromStr for AuctionResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AuctionResult".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "auction_finish_ts" => intermediate_rep.auction_finish_ts.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "auction_start_ts" => intermediate_rep.auction_start_ts.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "banner" => intermediate_rep.banner.push(<models::BannerAdObject as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "bid_type" => intermediate_rep.bid_type.push(<models::AuctionResultBidType as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "interstitial" => intermediate_rep.interstitial.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "price" => intermediate_rep.price.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    ...
                    "rewarded" => intermediate_rep.rewarded.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<models::AuctionResultStatus as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "winner_ad_unit_label" => intermediate_rep.winner_ad_unit_label.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "winner_ad_unit_uid" => intermediate_rep.winner_ad_unit_uid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "winner_demand_id" => intermediate_rep.winner_demand_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AuctionResult".to_string())
                }
            }
        ...
        std::result::Result::Ok(AuctionResult {
            ...
            price: intermediate_rep.price.into_iter().next(),
            rewarded: intermediate_rep.rewarded.into_iter().next(),
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in AuctionResult".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionResult>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionResult>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionResult - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AuctionResult as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AuctionResult - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionResult>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionResult>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionResult>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionResultBidType>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionResultBidType>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionResultBidType - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionResultBidType>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionResultBidType>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionResultBidType>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<AuctionResultStatus>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AuctionResultStatus>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AuctionResultStatus - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<AuctionResultStatus>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<AuctionResultStatus>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<AuctionResultStatus>> {
    type Error = String;
...
impl std::str::FromStr for BannerAdObject {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing BannerAdObject".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "format" => intermediate_rep.format.push(<models::AdFormat as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing BannerAdObject".to_string())
                }
            }
        ...
        std::result::Result::Ok(BannerAdObject {
            format: intermediate_rep.format.into_iter().next().ok_or_else(|| "format missing in BannerAdObject".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<BannerAdObject>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BannerAdObject>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BannerAdObject - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BannerAdObject as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into BannerAdObject - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<BannerAdObject>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<BannerAdObject>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<BannerAdObject>> {
    type Error = String;
...
impl BaseRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ) -> BaseRequest {
        BaseRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for BaseRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing BaseRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing BaseRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(BaseRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in BaseRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in BaseRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in BaseRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in BaseRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<BaseRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BaseRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BaseRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BaseRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into BaseRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<BaseRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<BaseRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<BaseRequest>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<Bid>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Bid>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Bid - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Bid> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Bid as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Bid - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Bid>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Bid>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::convert::TryFrom<header::IntoHeaderValue<BidType>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BidType>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BidType - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BidType as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into BidType - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<BidType>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<BidType>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::string::ToString for BiddingConfig {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            self.token_timeout_ms.as_ref().map(|token_timeout_ms| {
                [
                    "token_timeout_ms".to_string(),
                    token_timeout_ms.to_string(),
                ].join(",")
            }),
        ];
...
impl std::str::FromStr for BiddingConfig {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing BiddingConfig".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "token_timeout_ms" => intermediate_rep.token_timeout_ms.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing BiddingConfig".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<BiddingConfig>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<BiddingConfig>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for BiddingConfig - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <BiddingConfig as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into BiddingConfig - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<BiddingConfig>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<BiddingConfig>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<BiddingConfig>> {
    type Error = String;
...
impl ClickRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ) -> ClickRequest {
        ClickRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for ClickRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ClickRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "bid" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in ClickRequest".to_string()),
                    "show" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in ClickRequest".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing ClickRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(ClickRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in ClickRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in ClickRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in ClickRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in ClickRequest".to_string())?,
            bid: std::result::Result::Err("Nullable types not supported in ClickRequest".to_string())?,
            show: std::result::Result::Err("Nullable types not supported in ClickRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ClickRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ClickRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ClickRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ClickRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ClickRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<ClickRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<ClickRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<ClickRequest>> {
    type Error = String;
...
impl ConfigRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ) -> ConfigRequest {
        ConfigRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for ConfigRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "adapters" => return std::result::Result::Err("Parsing a container in this style is not supported in ConfigRequest".to_string()),
        ...
        std::result::Result::Ok(ConfigRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in ConfigRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in ConfigRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in ConfigRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in ConfigRequest".to_string())?,
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<ConfigRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<ConfigRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<ConfigRequest>> {
    type Error = String;
...
impl std::str::FromStr for ConfigResponse {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ConfigResponse".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "bidding" => intermediate_rep.bidding.push(<models::BiddingConfig as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "init" => intermediate_rep.init.push(<models::InitConfig as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "placements" => return std::result::Result::Err("Parsing a container in this style is not supported in ConfigResponse".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "segment" => intermediate_rep.segment.push(<models::Segment as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "token" => intermediate_rep.token.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ConfigResponse".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ConfigResponse>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ConfigResponse>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ConfigResponse - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ConfigResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ConfigResponse - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<ConfigResponse>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<ConfigResponse>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<ConfigResponse>> {
    type Error = String;
...
impl Device {
    #[allow(clippy::new_without_default)]
    pub fn new(connection_type: models::DeviceConnectionType, h: i32, hwv: String, js: i32, language: String, make: String, model: String, os: String, osv: String, ppi: i32, pxratio: f64, ua: String, w: i32, ) -> Device {
        Device {
            carrier: None,
            connection_type,
            geo: None,
...
impl std::string::ToString for Device {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            self.carrier.as_ref().map(|carrier| {
                [
                    "carrier".to_string(),
                    carrier.to_string(),
                ].join(",")
...
impl std::str::FromStr for Device {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing Device".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "carrier" => intermediate_rep.carrier.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "connection_type" => intermediate_rep.connection_type.push(<models::DeviceConnectionType as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "geo" => intermediate_rep.geo.push(<models::Geo as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "h" => intermediate_rep.h.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "hwv" => intermediate_rep.hwv.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "js" => intermediate_rep.js.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "language" => intermediate_rep.language.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "make" => intermediate_rep.make.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "mccmnc" => intermediate_rep.mccmnc.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    #[allow(clippy::redundant_clone)]
                    "osv" => intermediate_rep.osv.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ppi" => intermediate_rep.ppi.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "pxratio" => intermediate_rep.pxratio.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "type" => intermediate_rep.r#type.push(<models::DeviceType as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ua" => intermediate_rep.ua.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "w" => intermediate_rep.w.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing Device".to_string())
                }
            }
        ...
        std::result::Result::Ok(Device {
            ...
            connection_type: intermediate_rep.connection_type.into_iter().next().ok_or_else(|| "connection_type missing in Device".to_string())?,
            geo: intermediate_rep.geo.into_iter().next(),
            h: intermediate_rep.h.into_iter().next().ok_or_else(|| "h missing in Device".to_string())?,
            hwv: intermediate_rep.hwv.into_iter().next().ok_or_else(|| "hwv missing in Device".to_string())?,
            js: intermediate_rep.js.into_iter().next().ok_or_else(|| "js missing in Device".to_string())?,
            language: intermediate_rep.language.into_iter().next().ok_or_else(|| "language missing in Device".to_string())?,
            make: intermediate_rep.make.into_iter().next().ok_or_else(|| "make missing in Device".to_string())?,
            mccmnc: intermediate_rep.mccmnc.into_iter().next(),
            model: intermediate_rep.model.into_iter().next().ok_or_else(|| "model missing in Device".to_string())?,
            os: intermediate_rep.os.into_iter().next().ok_or_else(|| "os missing in Device".to_string())?,
            osv: intermediate_rep.osv.into_iter().next().ok_or_else(|| "osv missing in Device".to_string())?,
            ppi: intermediate_rep.ppi.into_iter().next().ok_or_else(|| "ppi missing in Device".to_string())?,
            pxratio: intermediate_rep.pxratio.into_iter().next().ok_or_else(|| "pxratio missing in Device".to_string())?,
            r#type: intermediate_rep.r#type.into_iter().next(),
            ua: intermediate_rep.ua.into_iter().next().ok_or_else(|| "ua missing in Device".to_string())?,
            w: intermediate_rep.w.into_iter().next().ok_or_else(|| "w missing in Device".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<Device>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Device>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Device - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Device as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Device - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Device>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Device>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::convert::TryFrom<header::IntoHeaderValue<DeviceConnectionType>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<DeviceConnectionType>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for DeviceConnectionType - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<DeviceConnectionType>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<DeviceConnectionType>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<DeviceConnectionType>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<DeviceType>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<DeviceType>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for DeviceType - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <DeviceType as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into DeviceType - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<DeviceType>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<DeviceType>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<DeviceType>> {
    type Error = String;
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<ErrorError>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<ErrorError>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<ErrorError>> {
    type Error = String;
...
impl std::string::ToString for ExternalWinner {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            self.demand_id.as_ref().map(|demand_id| {
                [
                    "demand_id".to_string(),
                    demand_id.to_string(),
                ].join(",")
...
impl std::str::FromStr for ExternalWinner {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ExternalWinner".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "price" => intermediate_rep.price.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ExternalWinner".to_string())
                }
            }
        ...
        std::result::Result::Ok(ExternalWinner {
            ...
            price: intermediate_rep.price.into_iter().next().ok_or_else(|| "price missing in ExternalWinner".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ExternalWinner>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ExternalWinner>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ExternalWinner - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ExternalWinner as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ExternalWinner - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<ExternalWinner>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<ExternalWinner>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<ExternalWinner>> {
    type Error = String;
...
impl std::string::ToString for Geo {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.lastfix.as_ref().map(|lastfix| {
                [
                    "lastfix".to_string(),
                    lastfix.to_string(),
                ].join(",")
            ...
            self.utcoffset.as_ref().map(|utcoffset| {
                [
                    "utcoffset".to_string(),
                    utcoffset.to_string(),
                ].join(",")
...
impl std::str::FromStr for Geo {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing Geo".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "accuracy" => intermediate_rep.accuracy.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    ...
                    #[allow(clippy::redundant_clone)]
                    "lastfix" => intermediate_rep.lastfix.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "lat" => intermediate_rep.lat.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "lon" => intermediate_rep.lon.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "utcoffset" => intermediate_rep.utcoffset.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "zip" => intermediate_rep.zip.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing Geo".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<Geo>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Geo>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Geo - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Geo> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Geo as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Geo - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Geo>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Geo>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl std::convert::TryFrom<header::IntoHeaderValue<GetAuctionAdTypeParameter>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GetAuctionAdTypeParameter>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GetAuctionAdTypeParameter - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<GetAuctionAdTypeParameter>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<GetAuctionAdTypeParameter>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<GetAuctionAdTypeParameter>> {
    type Error = String;
...
impl InitConfig {
    #[allow(clippy::new_without_default)]
    pub fn new(adapters: std::collections::HashMap<String, serde_json::Value>, tmax: i64, ) -> InitConfig {
        InitConfig {
            adapters,
            tmax,
        }
...
impl std::str::FromStr for InitConfig {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing InitConfig".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "adapters" => return std::result::Result::Err("Parsing a container in this style is not supported in InitConfig".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "tmax" => intermediate_rep.tmax.push(<i64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing InitConfig".to_string())
                }
            }
        ...
        std::result::Result::Ok(InitConfig {
            adapters: intermediate_rep.adapters.into_iter().next().ok_or_else(|| "adapters missing in InitConfig".to_string())?,
            tmax: intermediate_rep.tmax.into_iter().next().ok_or_else(|| "tmax missing in InitConfig".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<InitConfig>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<InitConfig>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for InitConfig - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <InitConfig as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into InitConfig - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<InitConfig>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<InitConfig>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<InitConfig>> {
    type Error = String;
...
impl LossRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, external_winner: models::ExternalWinner, ) -> LossRequest {
        LossRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for LossRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing LossRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "bid" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in LossRequest".to_string()),
                    "show" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in LossRequest".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "external_winner" => intermediate_rep.external_winner.push(<models::ExternalWinner as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing LossRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(LossRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in LossRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in LossRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in LossRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in LossRequest".to_string())?,
            bid: std::result::Result::Err("Nullable types not supported in LossRequest".to_string())?,
            show: std::result::Result::Err("Nullable types not supported in LossRequest".to_string())?,
            external_winner: intermediate_rep.external_winner.into_iter().next().ok_or_else(|| "external_winner missing in LossRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<LossRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<LossRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for LossRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <LossRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into LossRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<LossRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<LossRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<LossRequest>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<PostRewardAdTypeParameter>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PostRewardAdTypeParameter>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PostRewardAdTypeParameter - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<PostRewardAdTypeParameter>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<PostRewardAdTypeParameter>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<PostRewardAdTypeParameter>> {
    type Error = String;
...
impl std::string::ToString for Regulations {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            self.coppa.as_ref().map(|coppa| {
                [
                    "coppa".to_string(),
                    coppa.to_string(),
                ].join(",")
            }),
            self.eu_privacy.as_ref().map(|eu_privacy| {
                [
                    "eu_privacy".to_string(),
                    eu_privacy.to_string(),
                ].join(",")
            }),
            self.gdpr.as_ref().map(|gdpr| {
                [
                    "gdpr".to_string(),
                    gdpr.to_string(),
                ].join(",")
            ...
            self.us_privacy.as_ref().map(|us_privacy| {
                [
                    "us_privacy".to_string(),
                    us_privacy.to_string(),
                ].join(",")
            }),
        ];
...
impl std::str::FromStr for Regulations {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing Regulations".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "coppa" => intermediate_rep.coppa.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "eu_privacy" => intermediate_rep.eu_privacy.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "gdpr" => intermediate_rep.gdpr.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "iab" => return std::result::Result::Err("Parsing a container in this style is not supported in Regulations".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "us_privacy" => intermediate_rep.us_privacy.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing Regulations".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<Regulations>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Regulations>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Regulations - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Regulations as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Regulations - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Regulations>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Regulations>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<Regulations>> {
    type Error = String;
...
impl RewardRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ) -> RewardRequest {
        RewardRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for RewardRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing RewardRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "bid" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in RewardRequest".to_string()),
                    "show" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in RewardRequest".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing RewardRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(RewardRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in RewardRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in RewardRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in RewardRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in RewardRequest".to_string())?,
            bid: std::result::Result::Err("Nullable types not supported in RewardRequest".to_string())?,
            show: std::result::Result::Err("Nullable types not supported in RewardRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<RewardRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<RewardRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for RewardRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RewardRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into RewardRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<RewardRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<RewardRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<RewardRequest>> {
    type Error = String;
...
impl std::str::FromStr for Segment {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing Segment".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "uid" => intermediate_rep.uid.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing Segment".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<Segment>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Segment>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Segment - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Segment as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Segment - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Segment>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Segment>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl Session {
    #[allow(clippy::new_without_default)]
    pub fn new(battery: f64, cpu_usage: f64, id: uuid::Uuid, launch_monotonic_ts: i32, launch_ts: i32, memory_warnings_monotonic_ts: Vec<i32>, memory_warnings_ts: Vec<i32>, monotonic_ts: i32, ram_size: i32, ram_used: i32, start_monotonic_ts: i32, start_ts: i32, ts: i32, ) -> Session {
        Session {
            battery,
            cpu_usage,
            id,
...
impl std::string::ToString for Session {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            Some(self.memory_warnings_monotonic_ts.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(",")),
            Some("memory_warnings_ts".to_string()),
            Some(self.memory_warnings_ts.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(",")),
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "battery" => intermediate_rep.battery.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "cpu_usage" => intermediate_rep.cpu_usage.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "id" => intermediate_rep.id.push(<uuid::Uuid as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "launch_monotonic_ts" => intermediate_rep.launch_monotonic_ts.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "launch_ts" => intermediate_rep.launch_ts.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "memory_warnings_monotonic_ts" => return std::result::Result::Err("Parsing a container in this style is not supported in Session".to_string()),
                    "memory_warnings_ts" => return std::result::Result::Err("Parsing a container in this style is not supported in Session".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "monotonic_ts" => intermediate_rep.monotonic_ts.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ram_size" => intermediate_rep.ram_size.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ram_used" => intermediate_rep.ram_used.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "start_monotonic_ts" => intermediate_rep.start_monotonic_ts.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "start_ts" => intermediate_rep.start_ts.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "storage_free" => intermediate_rep.storage_free.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "storage_used" => intermediate_rep.storage_used.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ts" => intermediate_rep.ts.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
        ...
        std::result::Result::Ok(Session {
            battery: intermediate_rep.battery.into_iter().next().ok_or_else(|| "battery missing in Session".to_string())?,
            cpu_usage: intermediate_rep.cpu_usage.into_iter().next().ok_or_else(|| "cpu_usage missing in Session".to_string())?,
            id: intermediate_rep.id.into_iter().next().ok_or_else(|| "id missing in Session".to_string())?,
            launch_monotonic_ts: intermediate_rep.launch_monotonic_ts.into_iter().next().ok_or_else(|| "launch_monotonic_ts missing in Session".to_string())?,
            launch_ts: intermediate_rep.launch_ts.into_iter().next().ok_or_else(|| "launch_ts missing in Session".to_string())?,
            memory_warnings_monotonic_ts: intermediate_rep.memory_warnings_monotonic_ts.into_iter().next().ok_or_else(|| "memory_warnings_monotonic_ts missing in Session".to_string())?,
            memory_warnings_ts: intermediate_rep.memory_warnings_ts.into_iter().next().ok_or_else(|| "memory_warnings_ts missing in Session".to_string())?,
            monotonic_ts: intermediate_rep.monotonic_ts.into_iter().next().ok_or_else(|| "monotonic_ts missing in Session".to_string())?,
            ram_size: intermediate_rep.ram_size.into_iter().next().ok_or_else(|| "ram_size missing in Session".to_string())?,
            ram_used: intermediate_rep.ram_used.into_iter().next().ok_or_else(|| "ram_used missing in Session".to_string())?,
            start_monotonic_ts: intermediate_rep.start_monotonic_ts.into_iter().next().ok_or_else(|| "start_monotonic_ts missing in Session".to_string())?,
            start_ts: intermediate_rep.start_ts.into_iter().next().ok_or_else(|| "start_ts missing in Session".to_string())?,
            storage_free: intermediate_rep.storage_free.into_iter().next(),
            storage_used: intermediate_rep.storage_used.into_iter().next(),
            ts: intermediate_rep.ts.into_iter().next().ok_or_else(|| "ts missing in Session".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Session>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Session>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl ShowRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ) -> ShowRequest {
        ShowRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for ShowRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ShowRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "bid" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in ShowRequest".to_string()),
                    "show" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in ShowRequest".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing ShowRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(ShowRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in ShowRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in ShowRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in ShowRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in ShowRequest".to_string())?,
            bid: std::result::Result::Err("Nullable types not supported in ShowRequest".to_string())?,
            show: std::result::Result::Err("Nullable types not supported in ShowRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ShowRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ShowRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ShowRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ShowRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ShowRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<ShowRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<ShowRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<ShowRequest>> {
    type Error = String;
...
impl std::convert::TryFrom<header::IntoHeaderValue<Stats>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Stats>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Stats - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Stats> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Stats as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Stats - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<Stats>>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_values: header::IntoHeaderValue<Vec<Stats>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
impl StatsRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, stats: swagger::Nullable<models::Stats>, ) -> StatsRequest {
        StatsRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for StatsRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing StatsRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "stats" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in StatsRequest".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing StatsRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(StatsRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in StatsRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in StatsRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in StatsRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in StatsRequest".to_string())?,
            stats: std::result::Result::Err("Nullable types not supported in StatsRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<StatsRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<StatsRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for StatsRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <StatsRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into StatsRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<StatsRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<StatsRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<StatsRequest>> {
    type Error = String;
...
impl std::str::FromStr for SuccessResponse {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        std::result::Result::Ok(SuccessResponse {
            success: intermediate_rep.success.into_iter().next().ok_or_else(|| "success missing in SuccessResponse".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<SuccessResponse>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<SuccessResponse>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SuccessResponse - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SuccessResponse as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SuccessResponse - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "consent" => return std::result::Result::Err("Parsing a container in this style is not supported in User".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "coppa" => intermediate_rep.coppa.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "idfa" => intermediate_rep.idfa.push(<uuid::Uuid as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "idfv" => intermediate_rep.idfv.push(<uuid::Uuid as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "idg" => intermediate_rep.idg.push(<uuid::Uuid as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "tracking_authorization_status" => intermediate_rep.tracking_authorization_status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
        ...
        std::result::Result::Ok(User {
            ...
            tracking_authorization_status: intermediate_rep.tracking_authorization_status.into_iter().next().ok_or_else(|| "tracking_authorization_status missing in User".to_string())?,
        })
    }
}
...
impl WinRequest {
    #[allow(clippy::new_without_default)]
    pub fn new(app: models::App, device: models::Device, session: models::Session, user: models::User, ) -> WinRequest {
        WinRequest {
            app,
            device,
            ext: None,
...
impl std::str::FromStr for WinRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing WinRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "user" => intermediate_rep.user.push(<models::User as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "bid" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in WinRequest".to_string()),
                    "show" => return std::result::Result::Err("Parsing a nullable type in this style is not supported in WinRequest".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing WinRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(WinRequest {
            app: intermediate_rep.app.into_iter().next().ok_or_else(|| "app missing in WinRequest".to_string())?,
            device: intermediate_rep.device.into_iter().next().ok_or_else(|| "device missing in WinRequest".to_string())?,
            ext: intermediate_rep.ext.into_iter().next(),
            geo: intermediate_rep.geo.into_iter().next(),
            regs: intermediate_rep.regs.into_iter().next(),
            segment: intermediate_rep.segment.into_iter().next(),
            session: intermediate_rep.session.into_iter().next().ok_or_else(|| "session missing in WinRequest".to_string())?,
            token: intermediate_rep.token.into_iter().next(),
            user: intermediate_rep.user.into_iter().next().ok_or_else(|| "user missing in WinRequest".to_string())?,
            bid: std::result::Result::Err("Nullable types not supported in WinRequest".to_string())?,
            show: std::result::Result::Err("Nullable types not supported in WinRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<WinRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<WinRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for WinRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <WinRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into WinRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<header::IntoHeaderValue<Vec<WinRequest>>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_values: header::IntoHeaderValue<Vec<WinRequest>>) -> std::result::Result<Self, Self::Error> {
        let hdr_values : Vec<String> = hdr_values.0.into_iter().map(|hdr_value| {
            hdr_value.to_string()
        }).collect();
...
#[cfg(feature = "server")]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Vec<WinRequest>> {
    type Error = String;
